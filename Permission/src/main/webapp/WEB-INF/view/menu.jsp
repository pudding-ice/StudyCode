...
<div id="menu_dialog">
    <form id="menu_form" method="post">
        <table align="center" style="margin-top: 15px;">
            ...
            <tr>
                <td>父菜单</td>
                <td><input type="text" id="parentMenu" name="parent.id" class="easyui-combobox" placeholder="请选择父菜单"/>
                </td>
            </tr>
        </table>
    </form>
...
<div id="menu_dialog_bt">
    ...
    <a class="easyui-linkbutton" iconCls="icon-cancel" plain="true" id="cancel" data-cmd="cancel">取消</a>
</div>
